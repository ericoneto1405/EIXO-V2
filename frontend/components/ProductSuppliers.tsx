...
const ProductSuppliers: React.FC = () => {
    return (
        <div>
            <p className="text-gray-500 dark:text-gray-400 mb-6">Gerencie seus fornecedores de insumos e produtos.</p>
            <div className="bg-white dark:bg-dark-card rounded-xl shadow-lg p-12 text-center flex flex-col items-center justify-center h-96">
                ...
                <p className="text-gray-500 dark:text-gray-400 mt-2 max-w-md">A seção de cadastro de fornecedores de produtos está em construção e estará disponível em breve.</p>
            </div>
        </div>
    );
};
